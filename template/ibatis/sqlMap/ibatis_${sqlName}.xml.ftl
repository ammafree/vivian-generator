...
<!DOCTYPE sqlMap PUBLIC "-//ibatis.apache.org//DTD SQL Map 2.0//EN" "http://ibatis.apache.org/dtd/sql-map-2.dtd" >
 <sqlMap namespace="edu${className}" >

    <!-- ======================================================================== 
      COMMON （别名、resultMap、查询字段、sql...）
    ========================================================================= -->
    <typeAlias alias="${classNameLower}" type="${basePackage}.bo.${className}" />
    <typeAlias alias="${classNameLower}Vo" type="${basePackage}.vo.${className}Vo" />
    <typeAlias alias="query${className}Vo" type="${basePackage}.vo.Query${className}Vo" />
    ...
    <select id="query${className}Page" parameterClass="query${className}Vo"
		...
		<include refid="Page_SqlMap.pagePrefix"/>
			select 
			<include refid="edu${className}.select_column"/>
			<include refid="edu${className}.query${className}Page_where"/>
    ...
    <!--多条件组合查询-->
    <select id="query" resultMap="BaseResultMap" parameterClass="${classNameLower}">
        select <include refid="Base_Column_List"/>
